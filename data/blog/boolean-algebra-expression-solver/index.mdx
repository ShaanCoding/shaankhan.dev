...
\( (3 - 4) \times 5 \)
becomes:
\( 3 4 - 5 \times \) or \( 5 3 4 - \times \) respectively.
...
<CodeBlock src="boolean-algebra-expression-solver/algorithm" title="Shunting Yard Algorithm Pseudocode" language="markdown"/>
...
{/* 
<CustomLink href="https://github.com/your-github-repo/boolean-algebra-solver">Boolean Algebra Solver on GitHub</CustomLink> */}
