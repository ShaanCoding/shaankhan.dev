...
<figure>
    ...
    />
    <figcaption className="text-center text-muted-foreground">Figure 1: Johnson L, Cellular automata for real-time generation of infinite cave levels</figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center text-muted-foreground">Figure 2: Dungeon Generation using BSP Trees</figcaption>
</figure>
