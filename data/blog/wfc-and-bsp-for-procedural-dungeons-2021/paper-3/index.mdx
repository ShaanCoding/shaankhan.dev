...
<figure>    
    ...
    />
    <figcaption className="text-center text-muted-foreground">Figure 2: Proposed Diagram Flowchart</figcaption>
</figure>

Alternatively, the pseudocode implementation of the algorithm is also provided, available below:

<figure>
    <CodeBlock src="wfc-and-bsp-for-procedural-dungeons-2021/paper-3/figure3" title="Wave Function Collapse Algorithm" language="text"/>
    <figcaption className="text-center text-muted-foreground">Figure 3: Proposed Diagram Pseudocode</figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center text-muted-foreground">Figure 4: Wave Function Collapse + BSP Input</figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center text-muted-foreground">Figure 5: Wave Function Collapse + BSP Output</figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center text-muted-foreground">Figure 6: Wave Function Collapse + BSP Error</figcaption>
</figure>
